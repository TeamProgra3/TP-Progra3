...
import paciente.Paciente;
	 ...
	 * para que sea unicos
	 *
	 * **La variable "sueldo básico" es el sueldo base asignado a cada medico, el
...
public abstract class Medico implements IMedico, Serializable {
	...
	/**
	 * Metodo que a�ade a su array de consultas, una fecha e historia clinica de paciente a atender
	 *
	 */
	@Override
